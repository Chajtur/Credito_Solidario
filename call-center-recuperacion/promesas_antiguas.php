...
session_start();
$stat = $conn->prepare('call poblar_promesas_de_pago_historico(:user);');
        ...
        <div class="col s12">
            <ul id="creditos-list" class="collapsible" data-collapsible="accordion">
                <li class="collapsible-item-header avatar">
                    <i class="material-icons circle">access_time</i>
                    <span class="collapsible-title-header">Histórico de promesas de pagos
                        ...
                        <li>
                            <div class="collapsible-header sin-icon" id="collapsible<?php echo $credito['Numero_Prestamo'];?>">
                                <div class="row">
                                    ...
                                    <div class="col s6 m3 l3 hide-on-med-and-down estatusb truncate">L. <?php echo $credito['monto_pagado'];?></div>
                                </div>
                            ...
                            <div class="collapsible-body no-padding">
                                <div class="card blue-grey white-text z-depth-0 no-margin no-border-radius">
                                    <div class="card-content">
                                        <span class="card-title text-darken-4"><span class="light">Observación:</span> <?php echo (($credito['observacion'] != '' || $credito['observacion'] != null) ? $credito['observacion'] : 'Sin observación');?></span>
                                        <div class="row">
