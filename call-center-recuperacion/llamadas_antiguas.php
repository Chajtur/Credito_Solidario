...
session_start();
$stat = $conn->prepare('call poblar_ccc_historico(:user);');
        ...
        <div class="col s12">
            <ul id="creditos-list" class="collapsible" data-collapsible="accordion">
                <li class="collapsible-item-header avatar">
                    ...
                    <span class="collapsible-title-header">Histórico Llamadas
                    ...
                    <div class="collapsible-header-titles  sin-icon">
                        <div class="row">
                            ...
                            <div class="col m4 l4 hide-on-small-only">
                                <p class="collapsible-title">Razon</p>
                            </div>
                            <div class="col m3 l3 hide-on-med-and-down">
                                <p class="collapsible-title">Fecha de llamada</p>
                            </div>
                        </div>
                    </div>
                </li>
                        ...
                        <li>
                            <div class="collapsible-header sin-icon" id="collapsible<?php echo $credito['Numero_Prestamo'];?>">
                                <div class="row">
                                    ...
                                    <div class="col s4 m4 l4 hide-on-small-only identidadb truncate"><?php echo $credito['observacion']?></div>
                                    <div class="col s6 m3 l3 hide-on-med-and-down estatusb truncate"><?php echo $credito['Fecha_Llamada'];?></div>
                                </div>
