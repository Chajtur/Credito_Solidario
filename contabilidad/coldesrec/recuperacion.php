    ...
    <div class="col l4 m4 s4 offset-l2 offset-m2 offset-s2">
        ...
        <div class="card blue-grey" id="mensaje">
            <div class="card-content white-text">
                <span class="card-title">Reporte de Recuperación</span>
                <p>Seleccione, desde el calendario de la izquierda, la fecha inicial y final del reporte de recuperación que desea ver. <br>
                ...
                <div class="col s12 m12 l12 no-padding">
                    <ul id="projects-collection" class="collection z-depth-1">
                        <li class="collection-item avatar">
                            ...
                            <span id="titulo-del-collection" class="collection-header">Reporte de Recuperación</span>
                            <p id="descripcion-del-collection">lista de capital recuperado</p>
...
<script type="text/javascript" src="coldesrec/recuperacion/recuperacion.js"></script>