<?php
    ...
    $stat = $conn->prepare('select id, identidad, nombre, Fecha_Solicitud, Lugar_Nacimiento, Estado_Civil, 
        ...
        NombreAval, TelefonoAval, IdentidadAval
                            ...
                            <section>
                                <div class="wizard-content no-padding">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12 m12 l6">
                                            <input placeholder="digíte el número de teléfono" id="input-telefono" name="tel_fijo" type="text" class="required masked input-element" data-inputmask="'mask': '9999-9999'">
                                            <label for="tel_fijo" class="active" data-error="Campo vacío">Teléfono Fijo</label>
                                        </div>

                                        <div class="input-field col s6">
                                            <input placeholder="digíte el número de celular" id="input-celular" name="tel_celular" type="text" class="required masked input-element" data-inputmask="'mask': '9999-9999'">
