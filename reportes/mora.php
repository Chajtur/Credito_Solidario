<?php require 'head.php'; ?>
    ...
    <div class="card">
        <div class="row">
            <div class="col s12">
                <ul class="tabs">
                    <li class="tab col s3"><a class="active" href="#desembolsos">Mora</a></li>
            ...
            <div id="desembolsos" class="col s12">
                <form action="#" method="post">
                    <div class="card-content">
                        <h5>Reporte de Mora por Agencia</h5>
                        <div class="row">
                            <div class="input-field col l2 m2 s4">
                                <p>
                                    <input type="checkbox" id="select-all">
                                    <label for="select-all">Todas</label>
                                </p>
                            </div>
                            <div class="input-field col l10 m10 s8" id="options">
                                <select name="select_ifi_rec[]" id="select_ifi_rec" class="validate" required multiple>
                                   
                                    <option value="" selected disabled>Seleccione las Agencias...</option>

                                    <?php require '../php/agencias.php'; foreach($agencias as $agencia): ?>
