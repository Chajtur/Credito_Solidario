        ...
        <div class="wrapper">
            ...
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftside-navigation collapsible no-border" data-collapsible="accordion">
                    ...
                    <li id="home-gerencia" class="sin-icon menu-btn menu-btn-active" data-change="gerencia.php"><a onclick="hideMenuOnClick()" class="waves-effect waves-light"><i class="material-icons">home</i>Inicio</a></li>
                    <li id="reporte-general" class="sin-icon menu-btn" data-change="reporteGeneral.php"><a onclick="hideMenuOnClick()" class="waves-effect waves-light"><i class="material-icons">content_paste</i>Reporte General</a></li>
                    <li id="reporte-presidencial" class="sin-icon menu-btn" data-change="reportePresidencial2.php"><a onclick="hideMenuOnClick()" class="waves-effect waves-light"><i class="material-icons">account_balance</i>Reporte Presidencial</a></li>
                    <li id="reporte-movilizadores" class="sin-icon menu-btn" data-change="reporteMovilizadores.php"><a onclick="hideMenuOnClick()" class="waves-effect waves-light"><i class="material-icons">local_taxi</i>Movilizadores</a></li>
                    <li id="reporte-ifis" class="sin-icon menu-btn" data-change="reporteIfis.php"><a onclick="hideMenuOnClick()" class="waves-effect waves-light"><i class="material-icons">account_balance</i>IFIS</a></li>
                    <li id="carteras-filtradas" class="sin-icon menu-btn" data-change="carteras.php"><a onclick="hideMenuOnClick()" class="waves-effect waves-light"><i class="material-icons">work</i>Carteras</a></li>
                    <li id="edicion_metas" class="sin-icon menu-btn" data-change="metas/detalles_metas.php"><a onclick="hideMenuOnClick()" class="waves-effect waves-light"><i class="material-icons">edit</i>Editar Metas</a></li>
                    ...
                    <li>
                        <div class="collapsible-header custom truncate tooltipped" data-position="right" data-delay="10" data-tooltip="Colocación, Desembolsos y Recuperación"><i class="material-icons grey-text text-darken-1">menu</i>Estado</div><!--<i class="material-icons">account_balance</i>-->
                        <div class="collapsible-body custom">
                            <ul>
                                <li id="estado_colocacion" class="sin-icon menu-btn menu-btn" data-change="coldesrec/colocacion.php"><a onclick="hideMenuOnClick()" class="waves-effect waves-light"><i class="material-icons">keyboard_arrow_right</i>Colocación</a></li>
                                <li id="estado_desembolsos" class="sin-icon menu-btn menu-btn" data-change="coldesrec/desembolsos.php"><a onclick="hideMenuOnClick()" class="waves-effect waves-light"><i class="material-icons">keyboard_arrow_right</i>Desembolsos</a></li>
                                <li id="estado_recuperacion" class="sin-icon menu-btn menu-btn" data-change="coldesrec/recuperacion.php"><a onclick="hideMenuOnClick()" class="waves-effect waves-light"><i class="material-icons">keyboard_arrow_right</i>Recuperación</a></li>
                            </ul>
                        </div>
                    </li>
   ...
   <script src="../js/plugins/sweetalert-master/dist/sweetalert-dev.js"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#main-container').load('gerencia.php', function() {
                $('#loading').hide();
            });
