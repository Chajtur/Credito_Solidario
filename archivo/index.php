...
<body>
            ...
            <nav class="navbar-color">
                <div class="nav-wrapper row">
                    ...
                    <div class="left col s8 hide-on-med-and-down">
                        <h4 style="font-weight: 200;">| Archivo</h4>
                    </div>
        ...
        <div>
            ...
            <!-- START LEFT SIDEBAR NAV-->
                ...
                <ul id="mobile-demo" class="side-nav">
                    ...
                    <li id="menu-btn-digitar" class="menu-btn" data-change="linea-base.php"><a class="waves-effect waves-light"><i class="material-icons">keyboard</i>Digitación</a></li>
                    <li id="menu-btn-asignacion-hash" class="menu-btn" data-change="asignacion-hash.php"><a class="waves-effect waves-light"><i class="material-icons">font_download</i>Asignación de Hash</a></li>
                    <li id="menu-btn-codigo-humana" class="menu-btn" data-change="codigo-humana.php"><a class="waves-effect waves-light"><i class="material-icons">looks_two</i>Código Humana</a></li>
                    <li><a class="waves-effect waves-light" target="_blank" href="../consultas-nueva/index.php"><i class="material-icons">search</i>Consultas</a></li>
    ...
    <div class="fixed-action-btn horizontal tooltipped" data-tooltip="Acciones" data-delay="10" data-position="top">
        <a class="btn-floating btn-large blue">
            <i class="large material-icons">menu</i>
        </a>
        <ul>
            <li>
                <a class="btn-floating amber" id="modal-consulta-footer-activator">
                    <i class="material-icons">search</i>
                </a>
            </li>
            <li>
                <a class="btn-floating green" id="floating-refresh">
    ...
    <!-- COSULTAS FOOTER -->
    <?php require "../common/consulta-footer.php";?>
    <!-- END CONSULTAS FOOTER -->
