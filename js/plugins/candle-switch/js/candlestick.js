...
(function($) {
    ...
    Candlestick.prototype.wrapElement = function () {
        ...
        switch (this.settings.mode) {
            ...
            break;
            default:
                var html = '<div class="candlestick-wrapper candlestick-size-' + this.settings.size + '"><div data-candlestick-id="' + $id + '" class="candlestick-bg' + $classes + '"><div class="candlestick-toggle"></div><div class="candlestick-off"><i class="material-icons md-18">close</i></div><div class="candlestick-nc">&nbsp;</div><div class="candlestick-on"><i class="material-icons md-18">check</i></div><input type="hidden" class="' + this.element.attr('class') + '" value="' + this.default.value + '" name="' + this.default.name + '" id="' + $id + '"' + datas + $inputDisabled + $inputReadonly + '></div></div>';
            break;
        }
    ...
    Candlestick.prototype.setValue = function (cursor) {
        ...
        /**
        * Added by Rychiv4 to handle change event on input hidden
        */
