...
having fecha > if((select max(fecha) from bitacora_creditos where id_credito = :idcredito and razon = "Devuelto con correcciones") is null, "2015-1-1", 
(select max(fecha) from bitacora_creditos where id_credito = :idcredito and razon = "Devuelto con correcciones"));');
...
$stat = $conn->prepare('select distinct gestor from cartera_consolidada where Estatus_Prestamo = "Call Center" and agencia in ('.'"'.implode('","', $_SESSION['agencia']).'"'.')');
$stat->execute();
            ...
            <div class="">
                ...
                <div id="card-alert" class="card blue z-depth-0">
                    <div class="card-content white-text">
                        <p>Instrucciones: Marque las observaciones del crédito una vez haya completado la llamada.</p>
                    </div>
            ...
            <form class="row">
                <div id="nodopadre" class="col l12 m12 s12">
                    <ul class="collection with-header">
                        ...
                        <li class="collection-header">
                            <h5 class="light blue-text">Inconsistencias según metodología</h5>
                            <div class="row">
                                <div class="input-field col s12 m6 l6 grey-text truncate no-margin no-padding">
                                    <p>
...
$(document).ready(function(){
        ...
        var swalGuardar = function(){ //Metemos en una variable el sweet alert que envia los datos al archivo php
            ...
            function(){
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '../php/call-center/completar-verificar.php',
    ...
    */
    ...
    $('#btn-guardar-verificado-call-center').click(function(){
        ...
        if($('#observacionCheck')[0].checked == true && $('#observacionPersonalizada').val() == ''){
            Materialize.toast('El campo de observación está vacío', 2000);
            return false;
        }
    ...
    */
    ...
    $('.a-open-checklist').click(function(){
        ...
        //Asignacion del nombre en el titulo del modal
        ...
        if(auxthis.parent().parent().find('#nocontesto_counter').val() > 2){
            ...
            swal('Error', 'El beneficiario no ha contestado en 3 ocasiones, se registrará en bitácora el evento', 'error');
        ...
        function(contesto){
            ...
            if(contesto){
                ...
                $('#modal-observaciones').modal('open');
                $('#modal-observaciones').find('.modal-content').first().scrollTop(0);
