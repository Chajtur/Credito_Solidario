...
try{
    ...
    from cartera_consolidada where Estatus_Prestamo = "Para Correccion"');
    $stat->execute();
    
    $grupos_recibidos = $stat->fetchAll();
    
    $stat = $conn->prepare('select distinct gestor from cartera_consolidada where Estatus_Prestamo = "Para Correccion"');
    $stat->execute();
...
$(document).ready(function () {
    ...
    $('#recibidos-success').click(function(){
        ...
        function(){
            $.ajax({
                type: 'POST',
                url: '../php/coordinadores/recibir-grupo.php',
