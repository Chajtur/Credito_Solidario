...
<head>
    ...
    <title>Colocación - Crédito Solidario</title>
...
<body>
            ...
            <nav class="navbar-color">
                <div class="nav-wrapper row">
                    ...
                    <div class="left col s8 hide-on-med-and-down">
                        <h4 style="font-weight: 200;">| Colocación de Créditos</h4>
        ...
        <div>
            <!-- START LEFT SIDEBAR NAV-->
                <ul id="mobile-demo" class="side-nav">
                    ...
                    <li id="menu-btn-colocacion" class="menu-btn menu-btn-active" data-change="por-colocar.php"><a class="waves-effect waves-light"><i class="material-icons">account_balance</i>Colocación de Créditos</a></li>
                    ...
                    <li id="menu-btn-generayour-pbsz" class="menu-btn" data-change="../informatica/generar-pbs.php"><a class="waves-effect waves-light"><i class="material-icons">insert_drive_file</i>Generar PBS</a></li>
    ...
    $(document).ready(function(){
        ...
        $('#main-container').load('por-colocar.php', function(){
            $('#loading').hide();
        });
