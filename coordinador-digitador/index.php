        ...
        <div class="wrapper">
            ...
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftside-navigation collapsible collapsible-accordion no-border">
                    ...
                    <li class="no-padding">
                        <a class="collapsible-header active">Acciones coordinador <i class="material-icons">input</i></a>
                        <div class="collapsible-body no-padding">
                            <ul>
                                <li id="menu-btn-dashboard" class="menu-btn" data-change="dashboard.php"><a class="waves-effect waves-light no-margin"><i class="material-icons">dashboard</i>Dashboard</a></li>
                                <li id="menu-btn-agenda" class="menu-btn" data-change="../common/agenda.php"><a class="waves-effect waves-light no-margin"><i class="material-icons">work</i>Agenda</a></li>
                                <li id="menu-btn-reportar" class="menu-btn menu-btn-active" data-change="reportardesembolsos.php"><a class="waves-effect waves-light no-margin"><i class="material-icons">report</i>Reportar Desembolsos</a></li>
                                <li id="menu-btn-carteras" class="menu-btn" data-change="../coordinadores/carterasfiltradas.php"><a class="waves-effect waves-light no-margin"><i class="material-icons">work</i>Carteras</a></li>
                                <li id="menu-btn-descargarCarteras" class="menu-btn" data-change="../common/carteras.php"><a class="waves-effect waves-light no-margin"><i class="material-icons">work</i>Descargar Carteras</a></li>
                                <li id="menu-btn-documentos" class="menu-btn" data-change="../coordinadores/documentos.php"><a class="waves-effect waves-light no-margin"><i class="material-icons">description</i>Documentos</a></li>
                                ...
                                <ul class="collapsible collapsible-accordion">
                                    <li>
                                        ...
                                        <div class="collapsible-body custom">
                                            <ul>
                                                <li id="menu-btn-reasignar-beneficiarios" class="sin-icon menu-btn" data-change="../coordinadores/reasignar-creditos.php"><a onclick="hideMenuOnClick()" class="waves-effect waves-light"><i class="material-icons">keyboard_arrow_right</i>Créditos</a></li>
                                                <li id="estado_colocacion" class="sin-icon menu-btn" data-change="../coordinadores/reasignacion.php"><a onclick="hideMenuOnClick()" class="waves-effect waves-light"><i class="material-icons">keyboard_arrow_right</i>Asesores</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <li class="no-padding">
                        <a class="collapsible-header">Créditos <i class="material-icons">perm_media</i></a>
                        <div class="collapsible-body no-padding">
                            <ul>
                                <li id="menu-btn-crear-grupo" class="menu-btn" data-change="ingresar-grupo.php"><a class="waves-effect waves-light no-margin"><i class="material-icons">add_box</i>Creación de Grupos</a></li>
                    ...
                    <li class="no-padding">
                        <a class="collapsible-header">Coordinación <i class="material-icons">pan_tool</i></a>
                        <div class="collapsible-body no-padding">
                            <ul>
                                <li onclick="hideMenuOnClick()" id="menu-btn-recepcion" class="menu-btn" data-change="recepcion.php"><a class="waves-effect waves-light no-margin"><i class="material-icons">add_box</i>Recepción de Créditos</a></li>
                                <li id="menu-btn-verificar-coordinacion" class="menu-btn" data-change="verificar-coordinacion.php"><a class="waves-effect waves-light no-margin"><i class="material-icons">list</i>Verificar Créditos</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding">
