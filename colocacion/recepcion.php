...
try{
    ...
    from cartera_consolidada where Estatus_Prestamo = "Para Colocacion" and agencia = :agencia');
    $stat->bindValue(':agencia', $_SESSION['agencia']);
    $stat->execute();
    
    $grupos_recibidos = $stat->fetchAll();
    
    $stat = $conn->prepare('select distinct gestor from cartera_consolidada where Estatus_Prestamo = "Para Colocacion"');
    $stat->execute();
...
$(document).ready(function () {
    ...
    $('#recibidos-success').click(function(){
        ...
        swal({
            ...
            text: "Al precionar el boton de Confirmar, los grupos pasarán a estado Colocación",
            type: "warning",
        ...
        function(){
            $.ajax({
                type: 'POST',
                url: '../php/colocacion/recibir-grupo.php',
