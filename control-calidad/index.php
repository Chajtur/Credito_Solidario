...
<head>
    ...
    <title>Control de Calidad - Crédito Solidario</title>
...
<body>
            ...
            <nav class="navbar-color">
                <div class="nav-wrapper row">
                    ...
                    <div class="left col s8 hide-on-med-and-down">
                        <h4 style="font-weight: 200;">| Control de Calidad</h4>
                    </div>
        ...
        <div class="wrapper">
            ...
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftside-navigation">
                    ...
                    <li id="menu-btn-recepcion" class="menu-btn menu-btn-active" data-change="recibidos.php"><a class="waves-effect waves-light"><i class="material-icons">add_box</i>Grupos Recibidos</a></li>
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <ol class="breadcrumbs">
                                    <li><a href="index.html">Control de Calidad</a></li>
    ...
    $(document).ready(function(){
        ...
        $('#main-container').load('recibidos.php', function(){
            $('#loading').hide();
        });
