...
<body>
            ...
            <nav class="navbar-color">
                <div class="nav-wrapper row">
                    ...
                    <div class="left col s8 hide-on-med-and-down">
                        <h4 style="font-weight: 200;">| Ventanilla</h4>
                    </div>
        ...
        <div>
            ...
            <!-- START LEFT SIDEBAR NAV-->
                <ul id="mobile-demo" class="side-nav">
                    ...
                    <li class="no-padding menu-btn" id="menu-btn-principal" data-change="principal.php">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#main-container').load('principal.php', function(){
                $('#loading').hide();
            });
