...
try{
    ...
    where a.razon = "Correccion Call Center" and id_usuario = :usuario group by a.grupo_hash';
    ...
    $stat_bitacora = $conn->prepare('select * from bitacora_creditos where razon = "Correccion Call Center" and id_credito = :idcredito and id_usuario = :user');
