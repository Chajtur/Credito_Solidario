...
<head>
    ...
    <title>Call Center - Crédito Solidario</title>
...
<body>
            ...
            <nav class="navbar-color">
                <div class="nav-wrapper row">
                    ...
                    <div class="left col s8 hide-on-med-and-down">
                        <h4 style="font-weight: 200;">| Call Center Recuperación</h4>
                    </div>
        ...
        <div>
            ...
            <!-- START LEFT SIDEBAR NAV-->
                <ul id="mobile-demo" class="side-nav">
                    ...
                    <li id="menu-btn-llamadas" class="menu-btn menu-btn-active" data-change="llamadas.php"><a class="waves-effect waves-light"><i class="material-icons">phone_in_talk</i>Llamadas</a></li>
                    <li id="menu-btn-promesas" class="menu-btn" data-change="promesas.php"><a class="waves-effect waves-light"><i class="material-icons">list</i>Promesas de Pago</a></li>
                    <li id="menu-btn-llamadas_antiguas" class="menu-btn" data-change="llamadas_antiguas.php"><a class="waves-effect waves-light"><i class="material-icons">watch_later</i>Historico Llamadas</a></li>
                    <li id="menu-btn-promesas_antiguas" class="menu-btn" data-change="promesas_antiguas.php"><a class="waves-effect waves-light"><i class="material-icons">watch_later</i>Historico Promesas</a></li>
                    <!--<li id="menu-btn-Recuperar" class="menu-btn" data-change="recuperar.php"><a class="waves-effect waves-light"><i class="material-icons">replay</i>Recuperar Créditos</a></li>-->
                    <!--<li id="menu-btn-bitacora" class="menu-btn" data-change="bitacora-devueltos.php"><a class="waves-effect waves-light"><i class="material-icons">access_alarm</i>Bitácora de Devoluciones</a></li>-->
    ...
    $(document).ready(function(){
        ...
        $('#main-container').load('llamadas.php', function(){
            $('#loading').hide();
        });
