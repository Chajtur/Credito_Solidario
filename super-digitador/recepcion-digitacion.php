...
try{
    ...
    $stat = $conn->prepare('select distinct gestor from cartera_consolidada where Estatus_Prestamo = "Para Digitacion"');
    $stat->execute();
...
$(document).ready(function () {
    ...
    $('#select-filtro-gestor').on('change', function(){
        ...
        window.listObj.fuzzySearch($('#select-filtro-gestor option:selected').text());
