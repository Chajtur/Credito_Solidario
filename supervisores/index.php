...
// $stat = $conn->prepare('call obtener_visitas_responsables_pendientes(:usuario);');
...
<head>
    ...
    <title>Supervisores - Crédito Solidario</title>
            ...
            <nav class="navbar-color">
                <div class="nav-wrapper row">
                    ...
                    <div class="left col s8 hide-on-med-and-down">
                        <h4 style="font-weight: 200;">| Supervisores</h4>
                    </div>
        ...
        <div class="wrapper">
            ...
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftside-navigation">
                    ...
                    <li onclick="hideMenuOnClick()" id="menu-btn-dashboard" class="menu-btn menu-btn-active" data-change="dashboard.php"><a class="waves-effect waves-light"><i class="material-icons">dashboard</i>Dashboard</a></li>
                    <li onclick="hideMenuOnClick()" id="menu-btn-cartera-total" class="menu-btn" data-change="carteraTotal.php"><a class="waves-effect waves-light"><i class="material-icons">add_box</i>Cartera Total</a></li>
                    <li onclick="hideMenuOnClick()" id="menu-btn-metas" class="menu-btn" data-change="./metas/metasSupervisores.php"><a class="waves-effect waves-light"><i class="material-icons">add_box</i>Metas</a></li>
                    <li onclick="hideMenuOnClick()" id="menu-btn-casos" class="menu-btn" data-change="../common/casos-supervisores.php"><a class="waves-effect waves-light"><i class="material-icons">room_service</i>Casos</a></li>
                    <!-- <?php // if(count($visitas) > 0):?>

                        <li onclick="hideMenuOnClick()" id="menu-btn-casos" class="menu-btn" data-change="../common/casos.php"><a class="waves-effect waves-light"><i class="material-icons">disc_full</i>Casos</a></li>
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <ol class="breadcrumbs">
                                    <li><a href="index.html">Supervisores</a></li>
                                    <li class="active" id="breadcrum-title">Ventana Principal</li>
                                </ol>
                            </div>
                        </div>
                    </div>
