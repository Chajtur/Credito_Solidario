...
<head>
    ...
    <title>CDA - Crédito Solidario</title>
...
<body>
            ...
            <nav class="navbar-color">
                <div class="nav-wrapper row">
                    ...
                    <div class="left col s8 hide-on-med-and-down">
                        <h4 style="font-weight: 200;">| CDA</h4>
                    </div>
            ...
            <!-- START LEFT SIDEBAR NAV-->
                <ul id="mobile-demo" class="side-nav">
                    <?php require "../common/left-side-menu.php";?>
                     <li id="menu-btn-control-visitas" class="menu-btn menu-btn-active" data-change="control-visitas.php"><a class="waves-effect waves-light"><i class="material-icons">add_box</i>Control de Visitas</a></li> 
                    <!-- <li id="menu-btn-verificar" class="menu-btn" data-change="para-verificar.php"><a class="waves-effect waves-light"><i class="material-icons">list</i>Verificar Créditos</a></li> -->
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <ol class="breadcrumbs">
                                    <li><a href="index.html">CDA</a></li>
                                    <li  class="active" id="breadcrum-title">Control de Visitas</li>
                                </ol>
                            </div>
                        </div>
                    </div>
    ...
    $(document).ready(function(){
        ...
        $('#main-container').load('control-visitas.php', function(){
            $('#loading').hide();
        });
