...
if(isset($_POST['data'])){
    ...
    try{
        ...
        // Statements
        $stat_update = $conn->prepare('update cartera_consolidada set Estatus_Prestamo = "Call Center" where grupo_solidario_hash = :hash');
        ...
        foreach($obj as $grupo){
            ...
            foreach($creditos as $credito){
                ...
                agregarEnBitacora($stat_bitacora, $credito['id'], $grupo->hash, 'Reingreso de credito', 'Call Center', $_SESSION['user'], 'Reingreso de credito');
