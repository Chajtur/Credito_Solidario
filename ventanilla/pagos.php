...
where estado_credito = "Desembolsado" and b.agencia in ('.'"'.implode('","', $_SESSION['agencia']).'"'.')');
$stat->execute();
                                    ...
                                    <li>
                                        <div class="collapsible-header sin-icon">
                                            <div class="row">
                                                ...
                                                <div class="col s6 m3 l3 hide-on-small-only light truncate"><p class="collapsible-content">Al día</p></div>
                                        ...
                                        <div class="collapsible-body no-padding">
                                            <div class="card grey lighten-3 black-text z-depth-0 no-margin no-border-radius">
                                                <div class="card-content">
                                                    <?php 
                                                    $plazo = ($beneficiario['Ciclo'] == 1 ? 26 : ($beneficiario['Ciclo'] == 2 ? 52 : ($beneficiario['Ciclo'] == 3 ? 78 : 26)));
                                                    $pago = ((0.12/52)*($beneficiario['Monto_Desembolsado']))/(1-(pow((1+(0.12/52)),(-1*(preg_replace("/[^0-9]/","",$plazo))))));
                                                    ?>
                                                    <span class="card-title text-darken-4">
                                                        <span class="light">Cantidad a pagar:</span> <b>L. <?php echo number_format($pago,2,".",",");?></b>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col l6 m6 s12">   
                                                            <p><span class="light">Numero de Préstamo:</span> <span id="plazo-formated" class=""><?php echo $beneficiario['Numero_Prestamo'];?></span></p>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    $(document).ready(function(){
        ...
        $('.btn-plan-pagos').click(function(){
            ...
            var monto = $(this).parent().parent().parent().find('#monto').text();
        ...
        $('.btn-detalles-credito').click(function(){
