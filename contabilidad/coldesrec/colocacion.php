        ...
        <div class="card">
            <div class="card-content">
                ...
                <div class="input-field">
                    ...
                    <label for="select-filtro">Colocación por</label>
                </div>
                <div class="input-fielf">
                    <input type="checkbox" id="agrupado"/>
                    <label for="agrupado" class="tooltipped" data-position="right" data-delay="10" data-tooltip="Consolidar las colocaciones de todo el rango de fecha">Consolidar</label>
                </div>
            </div>
    ...
    <div class="col l4 m4 s4 offset-l2 offset-m2 offset-s2">
        ...
        <div class="card blue-grey" id="mensaje">
            <div class="card-content white-text">
                <span class="card-title">Reporte de Colocaciones</span>
                <p>Seleccione, desde el calendario de la izquierda, la fecha inicial y final del reporte de colocaciones que desea ver. <br>
                ...
                <div class="col s12 m12 l12 no-padding">
                    <ul id="projects-collection" class="collection z-depth-1">
                        <li class="collection-item avatar">
                            ...
                            <span id="titulo-del-collection" class="collection-header">Reporte de Colocaciones</span>
                            <p id="descripcion-del-collection">lista de créditos colocados</p>
...
<script type="text/javascript" src="coldesrec/colocacion/colocacion.js"></script>