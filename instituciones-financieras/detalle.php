                                ...
                                <span class="collapsible-title-header">Todos los pagos
                                    <div class="box secondary-content ">
                                        <div class="secondary-content actions">
                                            <a class="waves-effect waves-light btn-flat nopadding" id="generarEstadoCuenta">
...
function init(){
    ...
    // Eventos
    $('#btn-regresar').click(volverALista);
    $('.icon-collapse-search').click(toggleSearch);
    $('.btn-pagar').click(abrirModalPagar);
    $('#generarEstadoCuenta').click(generarPdfEstadoCuenta);
...
function generarPdfEstadoCuenta(){
    window.open('../php/instituciones-financieras/generar.pdf.estadocuenta.php?prestamo='+window.numero_prestamo,'_blank');
}
