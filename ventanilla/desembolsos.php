...
session_start();
$stat = $conn->prepare('
select Monto_Autorizado as Monto_Desembolsado, identidad, nombre, Fecha_Solicitud, Fecha_Colocacion, ciclo, ifi, id, Estatus_Prestamo
from cartera_consolidada
where Estatus_Prestamo = "Colocado" and agencia in ('.'"'.implode('","', $_SESSION['agencia']).'"'.')');
$stat->execute();
