                            ...
                            <ul class="collection with-header">
                                <li class="collection-header">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12 m6 l6 grey-text truncate">
                                            <p>
                                                <input name="faltaNotaAprobacion" type="checkbox" id="faltaNotaAprobacion" class="required filled-in checkbox-checklist" />
                                                <label class="tooltipped black-text" data-position="bottom" data-delay="50" data-tooltip="Falta nota de aprobación del supervisor y asesor técnico" for="faltaNotaAprobacion">Falta nota de aprobación del supervisor y asesor técnico</label>
                                            </p>
                                            <label for="faltaNotaAprobacion" id="faltaNotaAprobacion-error" class="green-text error-checkboxbutton error"></label>
                                        </div>
                                        <div class="input-field col s12 m6 l6 grey-text truncate">
                                            <p>
                                                <input name="faltaFirmaBeneficiario" type="checkbox" id="faltaFirmaBeneficiario" class="required filled-in checkbox-checklist" />
                                                <label class="tooltipped black-text" data-position="bottom" data-delay="50" data-tooltip="Falta firma del beneficiario" for="faltaFirmaBeneficiario">Falta firma del beneficiario</label>
                                            </p>
                                            <label for="faltaFirmaBeneficiario" id="faltaFirmaBeneficiario-error" class="green-text error-checkboxbutton error"></label>
                                        </div>
                                        <div class="input-field col s12 m6 l6 grey-text truncate">
                                            <p>
                                                <input name="plazoFormaPagoIncompleto" type="checkbox" id="plazoFormaPagoIncompleto" class="required filled-in checkbox-checklist" />
                                                <label class="tooltipped black-text" data-position="bottom" data-delay="50" data-tooltip="Plazo y forma de pago incompleto" for="plazoFormaPagoIncompleto">Plazo y forma de pago incompleto</label>
                                            </p>
                                            <label for="plazoFormaPagoIncompleto" id="plazoFormaPagoIncompleto-error" class="green-text error-checkboxbutton error"></label>
                                        </div>
                                    </div>
                                    <br>
                                </li>
                                ...
                                <li class="collection-header">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12 m6 l6 grey-text truncate">
                                            <p>
                                                <input name="group12" type="checkbox" id="inconsistenciaPlanInversion" class="required filled-in checkbox-checklist" />
                                                <label class="tooltipped black-text" data-position="bottom" data-delay="50" data-tooltip="Inconsistencias en el plan de inversión" for="inconsistenciaPlanInversion">Inconsistencias en el plan de inversión</label>
                                            </p>
                                            <label for="group12" id="grou12-error" class="green-text error-checkboxbutton error"></label>
                                        </div>
                                    </div>
                                ...
                                <li class="collection-header">
                                    <h5 class="light blue-text">Inconsistencias</h5>
                                    <div class="row">
                                        <div class="input-field col s12 m6 l6 grey-text truncate">
                                            <p>
                                                <input name="fechaNacimiento" type="checkbox" id="fechaNacimientoNoCoincideEdad" class="required filled-in checkbox-checklist" />
                                                <label class="tooltipped black-text" data-position="bottom" data-delay="50" data-tooltip="La fecha de nacimiento no coincide con la edad" for="fechaNacimientoNoCoincideEdad">La fecha de nacimiento no coincide con la edad</label>
                                            </p>
                                            <label for="fechaNacimiento" id="fechaNacimiento-error" class="green-text error-checkboxbutton error"></label>
                                        </div>
                                        <div class="input-field col s12 m6 l6 grey-text truncate">
                                            <p>
                                                <input name="masPuntoReferenciaDomicilio" type="checkbox" id="masPuntoReferenciaDomicilio" class="required filled-in checkbox-checklist" />
                                                <label class="tooltipped black-text" data-position="bottom" data-delay="50" data-tooltip="Especificar con mayor detalle el punto de referencia del domicilio y/o negocio" for="masPuntoReferenciaDomicilio">Especificar con mayor detalle el punto de referencia del domicilio y/o negocio</label>
                                            </p>
                                            <label for="masPuntoReferenciaDomicilio" id="masPuntoReferenciaDomicilio-error" class="green-text error-checkboxbutton error"></label>
                                        </div>
                                        <div class="input-field col s12 m6 l6 grey-text truncate">
                                            <p>
                                                <input name="referenciaFamiliarIncompleta" type="checkbox" id="referenciaFamiliarIncompleta" class="required filled-in checkbox-checklist" />
                                                <label class="tooltipped black-text" data-position="bottom" data-delay="50" data-tooltip="Referencia familiar y personal incompleta" for="referenciaFamiliarIncompleta">Referencia familiar y personal incompleta</label>
                                            </p>
                                            <label for="referenciaFamiliarIncompleta" id="referenciaFamiliarIncompleta-error" class="green-text error-checkboxbutton error"></label>
                                        </div>
                                        <div class="input-field col s12 m6 l6 grey-text truncate">
                                            <p>
                                                <input name="presentanMismoMarcoEstrategicoFoda" type="checkbox" id="presentanMismoMarcoEstrategicoFoda" class="required filled-in checkbox-checklist" />
                                                <label class="tooltipped black-text" data-position="bottom" data-delay="50" data-tooltip="Las solicitudes presentan mismo Marco Estratégico y FODA" for="presentanMismoMarcoEstrategicoFoda">Las solicitudes presentan mismo Marco Estratégico y FODA</label>
                                            </p>
                                            <label for="presentanMismoMarcoEstrategicoFoda" id="presentanMismoMarcoEstrategicoFoda-error" class="green-text error-checkboxbutton error"></label>
                                        </div>
                                        <div class="input-field col s12 m6 l6 grey-text truncate">
                                            <p>
                                                <input name="faltanPuntosReferenciaCroquis" type="checkbox" id="faltanPuntosReferenciaCroquis" class="required filled-in checkbox-checklist" />
                                                <label class="tooltipped black-text" data-position="bottom" data-delay="50" data-tooltip="Faltan puntos de referencia en el croquis" for="faltanPuntosReferenciaCroquis">Faltan puntos de referencia en el croquis</label>
                                            </p>
                                            <label for="faltanPuntosReferenciaCroquis" id="faltanPuntosReferenciaCroquis-error" class="green-text error-checkboxbutton error"></label>
                                        </div>
                                        <div class="input-field col s12 m6 l6 grey-text truncate">
                                            <p>
                                                <input name="inconsistenciasPlanInversion" type="checkbox" id="inconsistenciasPlanInversion" class="required filled-in checkbox-checklist" />
                                                <label class="tooltipped black-text" data-position="bottom" data-delay="50" data-tooltip="Inconsistencias en el plan de inversión" for="inconsistenciasPlanInversion">Inconsistencias en el plan de inversión</label>
                                            </p>
                                            <label for="inconsistenciasPlanInversion" id="inconsistenciasPlanInversion-error" class="green-text error-checkboxbutton error"></label>
                                        </div>
                                        <div class="input-field col s12 m6 l6 grey-text truncate">
                                            <p>
                                                <input name="inconsistenciaSolicitudAprobacion" type="checkbox" id="inconsistenciaSolicitudAprobacion" class="required filled-in checkbox-checklist" />
                                                <label class="tooltipped black-text" data-position="bottom" data-delay="50" data-tooltip="Inconsistencia en el plan de inversión" for="inconsistenciaSolicitudAprobacion">Inconsistencia en el plan de inversión</label>
                                            </p>
                                            <label for="inconsistenciaSolicitudAprobacion" id="inconsistenciaSolicitudAprobacion-error" class="green-text error-checkboxbutton error"></label>
                                        </div>
                                    </div>
                                    <br>
                                </li>
        ...
        var swalGuardar = function(){ //Metemos en una variable el sweet alert que envia los datos al archivo php
            ...
            function(){
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '../php/control-calidad/completar-verificar.php',
                    ...
                    success: function(data){
                        ...
                        if(data == "true"){
                            ...
                            $('#menu-btn-verificar').trigger('refresh'); //Actualizamos el main-container gracias a data-change.js
                            ...
                            swal("Se devolvieron los créditos", "Se detectaron observaciones en el departamento: "+(data == "Ingresado" ? "Créditos" : "Call Center"), "info");
                            $('#menu-btn-verificar').trigger('refresh'); 
