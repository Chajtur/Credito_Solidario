 $(document).ready(function(){
    ...
    $('#breadcrum-title').text('Reporte de Recuperación');
    ...
    $('.generar-excel').click(function(){
        ...
        $.ajax({
            type: 'POST',
            url: 'coldesrec/recuperacion/generar-excel.php',
            data: obj,
    ...
    $('#btn-generar').click(function(){
        ...
        current.fadeOut(100, function(){
            ...
            $.ajax({
                type: 'POST',
                url: '../php/gerencia/reporte_recuperacion.php',
                data: obj,
                success: function(data){
                    
                    var obj = JSON.parse(data);
                    delete window.listrecuperacion;
                    ...
                    $('#loading-current').fadeOut(100, function(){
                        ...
                        window.listrecuperacion = new List('projects-collection', options);
