...
$(function() {
  ...
  * Plugin initialization
  ...
  $("select[required]").css({display:"inline", height:0, padding:0, width:0, margin:-10});
  ...
  $('.dropdown-button').dropdown({
    ...
    // PerfilOnNav Dropdown
  $('.perfil-on-nav-button').dropdown({
      inDuration: 300,
      outDuration: 225,
      constrain_width: true, // Does not change width of dropdown to that of the activator
  ...
  $('.rightside-navigation').height(righttnav).perfectScrollbar({
    ...
    /*var tabsscroll = $('.tabs').width();
    $('.tabs-fixed-width').width(tabsscroll).perfectScriollbar({
        suppressScrollX: true
    });*/
