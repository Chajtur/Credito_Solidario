<?php
	...
	if(isset($_POST['data'])){
	    ...
	    try {
			...
			$stat = $conn->prepare('UPDATE cartera_consolidada SET monto_Autorizado = :monto, Forma_de_Pago = :frecuencia, Valor_del_Ahorro = :valor, Plazo = :plazo, Estatus_Prestamo = "Colocacion" WHERE id = :idcredito');
			...
			foreach ($data as $index => $value) {
				$stat->bindValue(':monto', $value->monto, PDO::PARAM_STR);
