...
<body><br>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-body"  style="background-image: url(logocredito.png);background-size: contain; background-repeat:none; filter: grayscale(100%)">
...
<body><br>
    <div class="container-fluid">
        <div class="panel panel-default" style="background-image: url(logocredito.png);background-size: contain; background-repeat:none; filter: grayscale(100%)">
